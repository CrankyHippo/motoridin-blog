...
const CommentsForm = ({ slug }) => {
  ...
  return (
    <div className="p-8 pb-12 mb-8 bg-white rounded-lg shadow-lg">
      ...
      <div className="mt-8">
        <button type="button" onClick={handlePostSubmission} className="inline-block px-8 py-3 text-lg font-medium text-white transition duration-500 bg-red-600 rounded-full cursor-pointer ease hover:bg-black">Post Comment</button>
